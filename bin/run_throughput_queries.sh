...
bin/spark-sql --master ${URL} ${DRIVER_OPTIONS} ${EXECUTOR_OPTIONS} ${ADDITION_SPARK_OPTIONS} -database TPCDS -f ${OUTPUT_DIR}/query_0.sql > ${OUTPUT_DIR}/query_0.res 2>&1
lines=`cat ${OUTPUT_DIR}/query_0.res | grep "Time taken:"`
